...
# Datos que utilizaremos para el análisis  y desarrollo de nuestro trabajo, sobre las provincias de la República Dominicana:
...
# Verificamos el sistema de coordenadas que poseen los datos, y lo transformamos al 32619, para utilizarlo en UTM.
...
# Realizamos el Análisis Exploratorios de los Datos, para lograr obtener las estadísticas del año 
...
# Generamos tres variograma modelo, para elegir el que tenga mejor comportamiento con los datos, y este se utilizará en la interpolación por Kriging. 
...
# El comportamiento de los datos visualizados a través de los variogramas muestrales generados indican que tienen un Comportamiento Cuadrático, 
# además, no tiene el efecto Pepita, porque los valores no se aproximan a cero. Representan variables continuas e infinitamente diferenciables. 
# Por lo que no puede cambiar rápidamente.


# Aquí generamos una cuadrícula para la República Dominicana, con los datos de las predicciones, la cual será de baja resolución, usaremos la dimensión de 3x3km, antes de iniciar la interpolación.
# Sobre esta cuadrícula, ejecutamos la interpolación por kriging ordinario.
